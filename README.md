...
-----> [Download the beta version of the software!](https://github.com/Riccardo-Foschi/LumExtract_PhotometricStereo/releases/download/v1.0.0/LumExtr_version1.0.0.zip) <-----  
